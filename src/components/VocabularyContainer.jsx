      ...
      <header className="vocab-control-row">
        <div className="vocab-control-left">
          ...
          <div className="vocab-title-wrapper">
            ...
            <span className="vocab-subtitle">{filteredWords.length}</span>
          </div>
        </div>
          ...
          <div className="quiz-card">
            {quizIndex < quizQuestions.length ? (
              <>
                <div className="quiz-header">
                  <div className="quiz-progress">
                    <div>{sectionQuizLabel}</div>
                    <div key={quizIndex}>{quizIndex + 1} / {quizQuestions.length}</div>
                  </div>
              ...
              <div className="quiz-summary-box minimalistic">
                {quizScore === quizQuestions.length && <div style={{ fontSize: '48px', textAlign: 'center', marginBottom: '16px' }}>🏆</div>}
